...
_CFFI_UNUSED_FN
static void _cffi_checkfld_typedef_student(student *p)
{
...
static void _cffi_d_display(student x0)
{
  display(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_display(PyObject *self, PyObject *arg0)
{
  student x0;
...
#else
static void _cffi_f_display(student *x0)
{
  { display(*x0); }
}
#endif
...
static const struct _cffi_global_s _cffi_globals[] = {
  { "display", (void *)_cffi_f_display, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 0), (void *)_cffi_d_display },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_myStructure(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_myStructure(void) { return NULL; }
#  else
     initmyStructure(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_myStructure(void)
{
  return _cffi_init("myStructure", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initmyStructure(void)
{
  _cffi_init("myStructure", 0x2601, &_cffi_type_context);
}
#endif
