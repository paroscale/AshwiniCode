...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_myPythonCBinding(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_myPythonCBinding(void) { return NULL; }
#  else
     initmyPythonCBinding(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_myPythonCBinding(void)
{
  return _cffi_init("myPythonCBinding", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initmyPythonCBinding(void)
{
  _cffi_init("myPythonCBinding", 0x2601, &_cffi_type_context);
}
#endif
